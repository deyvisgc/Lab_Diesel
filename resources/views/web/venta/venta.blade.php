...
<section class="our_project2_area project_grid_three">
    <div class="container">
        <div class="main_c_b_title">
            <h2>VENTA<br class="title_br">REPUESTOS</h2>
            <h6>Al mejor precio y de buena calidad</h6>
        </div>
                ...
                <div style="border: solid rgba(192,178,195,0.27) 1px; padding-top: 5px;border-radius: 5px;">
                    ...
                    <div style="margin-top: 10px; background-color: #f6e9ff;padding: 15px 0px 15px 0px;">
                        <div class="text-center">
                            ...
                            <p class=" text-center" style="padding-bottom: 10px; font-size: 20px;font-family: bold;color: red;">$ 250.00</p>
                            <a class=" text-center btn btn-primary" href="#">Comprar</a>
                        </div>
                    </div>
                </div>
            </div>
